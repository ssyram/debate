"""TUI 向导 — 14 步 curses 状态机生成辩论议题文件。"""
...
def cli(output: str | None, topic_file: str | None) -> None:
    ...
    if not is_curses_supported():
        ...
        console.print("  python -m debate_tool run my_topic.md")
        return
...
def main(argv=None):
    """Entry point for TUI wizard, callable from __main__.py router."""
    cli(args=argv)
